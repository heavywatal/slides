...
```{r simplify-diamonds, echo = FALSE, fig.height = 6, fig.width = 7, cache = FALSE}
diamonds %>%
...
```{r lm-diamonds, echo = FALSE, fig.height = 5, fig.width = 6, cache = FALSE}
diamonds %>%
  dplyr::filter(clarity %in% c("I1", "SI2", "IF")) %>%
...
```{r lm-bad, echo = FALSE, fig.height = 5, fig.width = 5, cache = FALSE}
n = 300L
a = 3
b = -3
...
```{r glm-better, echo = FALSE, fig.height = 5, fig.width = 10, cache = FALSE}
p_lm = p_pois +
  stat_smooth(formula = y ~ x, method = lm, se = FALSE) +
...
```{r weight-height, echo = FALSE, fig.height = 5, fig.width = 5, cache = FALSE}
n = 50
...
```{r weight-lines, echo = FALSE, fig.height = 5, fig.width = 5, cache = FALSE}
...
```{r weight-residual, echo = FALSE, fig.height = 5, fig.width = 10, cache = FALSE}
...
```{r weight-goodlines, echo = FALSE, fig.height = 5, fig.width = 10, cache = FALSE}
n = 200
...
```{r weight-grid, echo = FALSE, fig.height = 5, fig.width = 10, cache = FALSE}
...
```{r weight-lm, echo = FALSE, fig.height = 5, fig.width = 5, cache = FALSE}
...
```{r distribution, echo = FALSE, fig.height = 4, fig.width = 8, cache = FALSE}
...
```{r dbinom, echo = FALSE, fig.height = 3, fig.width = 3, cache = FALSE}
size = 3L; p = 0.5
...
```{r rbinom, echo = FALSE, fig.height = 3, fig.width = 11, cache = FALSE}
size = 3L; p = 0.5
...
```{r dunif, echo = FALSE, fig.height = 4, fig.width = 6, cache = FALSE}
...
```{r geometric, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
...
```{r dbinom-n, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
p = 0.25
...
```{r dpoisson, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
lambda = c(1, 5, 10)
...
```{r dexp, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
...
```{r dgamma, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
p2 = tidyr::crossing(x = seq(0, 3, length.out = 201), lambda) %>%
...
```{r gaussian, echo = FALSE, fig.height = 5, fig.width = 11, cache = FALSE}
...
```{r central-limit, echo = FALSE, fig.height = 3, fig.width = 11, cache = FALSE}
n = 40L
...
```{r binom-normal, echo = FALSE, fig.height = 3, fig.width = 11, cache = FALSE}
...
```{r poisson-normal, echo = FALSE, fig.height = 2.5, fig.width = 11, cache = FALSE}
purrr::map_dfr(c(1, 4, 16, 64, 256), ~{
...
```{r gamma-normal, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
...
```{r poisson-seed, echo = FALSE, fig.height = 4, fig.width = 4, cache = FALSE}
...
```{r poisson-seed-lambda, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
...
```{r poisson-seed-likelihood, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
...
```{r poisson-mle, echo = FALSE, fig.height = 3, fig.width = 10, cache = FALSE}
...
```{r poisson-mle-repl, echo = FALSE, fig.height = 5, fig.width = 11, cache = FALSE}
nrep = 1000L
...
```{r poisson-mle-nsam, echo = FALSE, fig.height = 4, fig.width = 11, cache = FALSE}
nrep = 1000L
...
一般化線形混合モデル、階層ベイズモデルなどを使ってもっと柔軟なモデリングを
