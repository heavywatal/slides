...
title = "4. ベイズ推定、階層ベイズモデル — 統計モデリング概論 DSHC 2022"
...
fit_yes = rstan::sampling(model_yes, data = mydata)
fit_no = rstan::sampling(model_no, data = mydata)
...
聞きながら手元で[tokiomarine2022-stan.ipynb](tokiomarine2022-stan.ipynb)を実行してもいいです。
