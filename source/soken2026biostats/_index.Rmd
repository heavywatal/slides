...
R_arm_pkg = paste0("`R-", R_version, "-arm64.pkg`")
R_x86_pkg = paste0("`R-", R_version, "-x86_64.pkg`")
R_win_exe = paste0("`R-", R_version, "-win.exe`")
...
1.  <https://cran.r-project.org/>
    ...
    - <iconify-icon inline icon="bi:windows"></iconify-icon>
      [Windows → base](https://cran.r-project.org/bin/windows/base) → `r R_win_exe`
    - <iconify-icon inline icon="bi:apple"></iconify-icon>
      [Mac](https://cran.r-project.org/bin/macosx/)
      → `r R_arm_pkg` (Apple Silicon) or `r R_x86_pkg` (Intel)
...
1.  メールでも直接でも相談してください。時間の許す限り対処します。
