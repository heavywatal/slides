...
```{r penguins-weight, fig.height = 4.5, fig.width = 4.5, warning = FALSE, dependson = "penguins"}
...
```{r penguins-multiple, echo = FALSE, include = FALSE}
fit4 = glm(bill_depth_mm ~ bill_length_mm + sex, data = penguins)
broom::tidy(fit4)
broom::glance(fit4)
added4 = modelr::add_predictions(penguins, fit4)
p_bill + geom_line(aes(y = pred, color = sex), data = added4, size = 1) +
