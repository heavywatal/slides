...
- <strong>"<i class="fab fa-windows"></i> Windows + 🇯🇵日本語ユーザー名"
...
- <span style="color: #999999;">
  できれば <i class="fab fa-apple"></i> Macを使うのが無難。<br>
  <i class="fab fa-linux"></i> Linuxが使えるならなお良い。
  </span>
...
<img src="/slides/image/hex-stickers/readxl.png" width="120" align="right">
</a>
