...
- Reduce noises
  - **Uniform enrivonment**: nutrients, temperature, etc.
...
- **Repeting simple tasks** is painful.
...
- Finding mistakes → **start over from the begining**
- Additional data → **start over from the begining**
