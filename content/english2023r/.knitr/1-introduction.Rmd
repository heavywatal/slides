...
- Gathering all the relevant files makes programming easier.
...
- The starting point of relative paths to input/output files.
- Double-clicking `*.Rproj` will launch RStudio with an appropriate working directory.
