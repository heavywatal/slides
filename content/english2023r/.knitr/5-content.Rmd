...
but `mutate()` is easy to incorporate into pipelines.
...
---
## Base R character functions are hard to use
...
<a href="https://stringr.tidyverse.org/">
<img src="/slides/image/cheatsheet/strings.png" width="100%">
...
A type to represent **categorical/qualitative variable**.
Looks like character, but actually **integer**.
