...
<img src="/slides/image/r4ds/relational-nycflights.png" height="500">
<br>
...
#| echo: false
cms_patient_care |> pivot_wider(names_from=type, values_from=score)
```
...
- `station` column becomes new column names.
- The values in `seen` get spread across multiple columns.
...
---
## Try `fish_encounters |> pivot_wider()`
...
Optional `values_fill = 0` fills missing value `NA` with `0`.
...
---
## 🔰 Challenge 1: transform and plot `economics`
...
---
## 🔰 Challenge 2: transform and plot `world_bank_pop`
...
---
## 🔰 Challenge 3: transform and plot `VADeaths`
