...
Mathematical Model 数理モデル<img src="image/hill-equation.png" width="150" style="float: right; margin: 0 -5px;">
: 数学的な方程式として記述されるもの。
...
Concrete Model 具象モデル<img src="image/weisberg-sfbay.jpg" width="260" style="float: right;">
: 具体的な事物で作られるもの。
