...
```{r freq-vs-bayes, echo = FALSE, fig.height = 4, fig.width = 4, cache = FALSE}
...
```{r coin-frequentist, echo = FALSE, fig.width = 11, fig.height = 3, cache = FALSE}
size = 1L; p = 0.5
...
```{r coin-bayesian, echo = FALSE, fig.width = 11, fig.height = 3, cache = FALSE}
...
```{r venn, echo = FALSE, fig.width = 6, fig.height = 3, cache = FALSE}
...
```{r prior-beta, echo = FALSE, fig.width = 3, fig.height = 3, cache = FALSE}
size = 1L; p = 0.5
X = c(0L, 0L, 0L, 1L, rbinom(496L, size, p))
...
```{r likelihood-binom, echo = FALSE, fig.width = 3, fig.height = 3, cache = FALSE}
...
```{r posterior-beta, echo = FALSE, fig.width = 3, fig.height = 3, cache = FALSE}
df_beta %>%
  dplyr::filter(i == 4) %>%
  ggplot() + aes(p, Density) +
  geom_area(fill = "#3366ff", alpha = 0.5) +
...
```{r integrate, echo = FALSE, fig.width = 6, fig.height = 4, cache = FALSE}
n_head = 6
n_total = 10
...
```{r circle, echo = FALSE, fig.width = 4, fig.height = 4, cache = FALSE}
n = 100L
...
```{r mcpdf, echo = FALSE, fig.width = 11, fig.height = 6, cache = FALSE}
n = 800
...
```{r metropolis, echo = FALSE, fig.width = 11, fig.height = 3.5, cache = FALSE}
n_head = 12
n_total = 20
dp = 0.02
...
```{r metropolis-trajectory, echo = FALSE, fig.show = "animate", animation.hook = "gifski", interval = 0.2, fig.width = 12, fig.height = 6, cache = FALSE}
dp = 0.05
...
```{r propto-lik, echo = FALSE, fig.width = 11, fig.height = 4, cache = FALSE}
...
```{r gibbs, echo = FALSE, fig.show = "animate", animation.hook = "gifski", interval = 0.1, fig.width = 5, fig.height = 5, cache = FALSE}
...
```{r chains, echo = FALSE, fig.height = 5, fig.width = 12, cache = FALSE}
...
```{r warmup, echo = FALSE, fig.height = 5, fig.width = 12, cache = FALSE}
cowplot::plot_grid(
...
```{r thin, echo = FALSE, fig.height = 5, fig.width = 7, cache = FALSE, message = FALSE}
p_trace +
...
```{r convergence, echo = FALSE, fig.height = 3, fig.width = 11, cache = FALSE, message = FALSE, warning = FALSE}
...
set.seed(42)
```
```{r stan-binom, fig.width = 4, fig.height = 4, cache = FALSE}
true_p = 0.7
N = 40L
...
```{r stan-binom-model, fig.width = 4, fig.height = 4, cache = FALSE}
...
```{r stan-binom-sample, fig.width = 4, fig.height = 3, cache = FALSE}
...
```{r stan-binom-fit, fig.width = 4, fig.height = 3, cache = FALSE}
print(fit)
```
...
```{r stan-binom-traceplot, fig.width = 11, fig.height = 4, cache = FALSE}
rstan::stan_trace(fit)
```
...
```{r stan-binom-ac, fig.width = 4, fig.height = 4, cache = FALSE}
...
```{r stan-binom-hist, fig.width = 4, fig.height = 4, cache = FALSE}
...
```{r stan-penguins-glm, echo = FALSE, fig.width = 7, fig.height = 4, cache = FALSE, warning = FALSE}
...
```{r stan-penguins-bill-data, echo = FALSE, fig.width = 7, fig.height = 4, cache = FALSE}
data = penguins %>%
...
```{r stan-penguins-model, fig.width = 4, fig.height = 4, cache = FALSE}
model = rstan::stan_model("penguins.stan")
```

モデルとデータを使ってMCMCサンプリング:

```{r stan-penguins-sample, fig.width = 4, fig.height = 3, cache = FALSE}
fit = rstan::sampling(model, data = data)
```
...
```{r stan-penguins-fit, fig.width = 4, fig.height = 3, cache = FALSE}
print(fit)
```
...
```{r stan-penguins-traceplot, fig.width = 11, fig.height = 4, cache = FALSE}
rstan::stan_trace(fit)
```
...
```{r stan-penguins-ac, fig.width = 11, fig.height = 4, cache = FALSE}
...
```{r stan-penguins-hist, fig.width = 11, fig.height = 3, cache = FALSE}
rstan::stan_hist(fit, bins = 30)
```
...
```{r stan-penguins-regression, fig.width = 4, fig.height = 4, cache = FALSE, warning = FALSE}
...
```{r rstanarm-penguins, fig.width = 8, fig.height = 4, cache = FALSE, message = FALSE, warning = FALSE}
library(rstanarm)
library(tidybayes)
...
```{r rstanarm-penguins-multi, fig.width = 8, fig.height = 5, cache = FALSE, message = FALSE, warning = FALSE}
...
```{r stan-glmm-prep, echo=FALSE, fig.width = 4, fig.height = 3, cache = FALSE, message = FALSE}
ninds = 100L
mu_ind = 0.5
sd_ind = 3
df_od = tibble::tibble(
...
```{r stan-glmm-print, echo = FALSE, fig.width = 4, fig.height = 3, cache = FALSE}
print(fit)
```
...
```{r stan-glmm, echo = FALSE, fig.width = 11, fig.height = 7, cache = FALSE}
.pars = c("a", "s", "r[1]", "r[2]")
...
```{r student_t, echo = FALSE, fig.height = 5, fig.width = 10, cache = FALSE}
...
```{r non-linear, echo = FALSE, fig.width = 10, fig.height = 5, cache = FALSE}
