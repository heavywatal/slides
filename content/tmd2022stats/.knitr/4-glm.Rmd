...
p_pois +
  ...
  ggridges::geom_vridgeline(aes(x, y, width = density * 0.5, group = x),
    data = df_bars, fill = "#3366ffaa", linetype = 0)
```
...
ggplot(df_weight) + aes(height, weight) +
  ...
  ggridges::geom_vridgeline(aes(width = density * 0.08, group = height),
    data = df_ridges, fill = "#3366ffaa", linetype = 0) +
...
p_lm = p_pois +
  ...
  ggridges::geom_vridgeline(aes(width = density * 0.4, group = body_mass),
    data = df_lm, fill = "#3366ffaa", linetype = 0)
# p_lm
...
d1 = modelr::add_predictions(panguins_bill_nona, fit1, type = "response")
d2 = modelr::add_predictions(panguins_bill_nona, fit2, type = "response")
d3 = modelr::add_predictions(panguins_bill_nona, fit3, type = "response")
