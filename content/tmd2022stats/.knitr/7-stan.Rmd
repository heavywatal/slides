...
coin_model = cmdstan_model("stan/coin.stan")
...
model_cred = cmdstan_model("stan/lm-credible.stan")
fit_cred = model_cred$sample(data_cred, seed = 19937L, refresh = 0)
