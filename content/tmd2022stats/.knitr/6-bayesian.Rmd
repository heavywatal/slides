...
mod_yes = cmdstan_model("stan/converge-yes.stan", pedantic = TRUE)
...
mod_no = cmdstan_model("stan/converge-no.stan", pedantic = TRUE)
fit_no = mod_no$sample(data = convdata, seed = 24601L, refresh = 0)
