...
tibble::tibble(p = seq(0, 1, 0.02), L = dbinom(1, 4, p)) |>
  ggplot() + aes(p, L) +
  geom_line(color = "#3366ff", linewidth = 2) +
...
p_point = df_density |>
  ...
  geom_hline(yintercept = 0) +
  geom_line(color = "#999999", linewidth = 1) +
  geom_vline(aes(xintercept = p), data = .map, color = .colors["map"], linewidth = 1) +
  geom_vline(aes(xintercept = p), data = .med, color = .colors["med"], linewidth = 1) +
  geom_vline(aes(xintercept = p), data = .eap, color = .colors["eap"], linewidth = 1) +
...
df_point |>
  ggplot() + aes(p, logLik) +
  geom_segment(data = df_arrow, .aes, linejoin = "mitre", linewidth = 1, position = position_nudge(0, +0.008), arrow = .ar) +
  geom_segment(data = df_arrow, .aes, linejoin = "mitre", linewidth = 1, position = position_nudge(0, -0.008), arrow = .ar2, alpha = 0.33) +
