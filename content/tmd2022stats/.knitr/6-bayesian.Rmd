...
<img src="figure/circle-1.png" align="right">
...
```{cat, converge-yes-stan}
#| engine.opts: !expr 'list(file = "stan/converge-yes.stan")'
#| cache.rebuild: !expr '!file.exists("stan/converge-yes.stan")'
data {
  int<lower=0> N;
  array[N] int x;
}
...
```
```{cat, converge-no-stan}
#| engine.opts: !expr 'list(file = "stan/converge-no.stan")'
#| cache.rebuild: !expr '!file.exists("stan/converge-no.stan")'
data {
  int<lower=0> N;
  array[N] int x;
}
...
```{cat, coin-stan}
#| engine.opts: !expr 'list(file = "stan/coin.stan")'
#| cache.rebuild: !expr '!file.exists("stan/coin.stan")'
#| lang: stan
data {
  int<lower=0> N;
  array[N] int x;
