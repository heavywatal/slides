+++
url = "soken2026biostats/3-structure1.html"
linktitle = "データ構造の処理1: 抽出、集約など。"
title = "3. データ構造の処理1: 抽出、集約など。 — 生物統計学 2026 総研大"
...
<li><a href="7-distribution.html">確率分布、尤度</a>
<li><a href="8-glm.html">一般化線形モデル(GLM)、個体差</a>
<li><a href="9-bayesian.html">ベイズの定理、MCMC</a>
<li><a href="10-stan.html">Stan、階層ベイズモデル(HBM)</a>
</ol>

<div class="footnote">
2026-07-29 葉山
<a href="https://heavywatal.github.io/slides/soken2026biostats/">https://heavywatal.github.io/slides/soken2026biostats/</a>
</div>
...
[計算順序が四則演算や論理演算より先](https://stat.ethz.ch/R-manual/R-patched/library/base/html/Syntax.html)であることに注意。
...
複数の値を返す関数で集約する場合は亜種 `reframe()` を使う。\
e.g., `range()`, `quantile()`, etc.
</aside>
...
```
    ...
    1  0.23     Ideal     E     SI2  61.5    55  51866.6 3.95 3.98 2.43 1417.391
    2  0.21   Premium     E     SI1  59.8    61  51866.6 3.89 3.84 2.31 1552.381
    3  0.23      Good     E     VS1  56.9    65  52025.7 4.05 4.07 2.31 1421.739
    4  0.29   Premium     I     VS2  62.4    58  53139.4 4.20 4.23 2.63 1151.724
   --                                                                           
53937  0.72      Good     D     SI1  63.1    55 438638.7 5.69 5.75 3.61 3829.167
53938  0.70 Very Good     D     SI1  62.8    60 438638.7 5.66 5.68 3.56 3938.571
53939  0.86   Premium     H     SI2  61.0    58 438638.7 6.15 6.12 3.74 3205.814
53940  0.75     Ideal     D     SI2  62.2    55 438638.7 5.83 5.87 3.64 3676.000
```
