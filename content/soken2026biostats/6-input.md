+++
url = "soken2026biostats/6-input.html"
linktitle = "データ入力、レポート作成"
title = "6. データ入力、レポート作成 — 生物統計学 2026 総研大"
...
```
Error in `nchar()`:
! invalid multibyte string, element 2
```
...
- **R (≥ 4.6.1)**: 最新版 – 0.1 くらいまでが許容範囲
- **RStudio (≥ 2026.07.1+147)**: Quarto CLI を同梱
