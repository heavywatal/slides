+++
url = "soken2026biostats/1-introduction.html"
linktitle = "導入: データ解析の全体像。Rの基本。"
title = "1. 導入: データ解析の全体像。Rの基本。 — 生物統計学 2026 総研大"
...
: <small>[VS Code](https://code.visualstudio.com/docs/languages/r)
  やその亜種
