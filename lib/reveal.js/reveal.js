...
</html>`),!e)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){let o=t.getConfig().url,r=typeof o=="string"?o:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;d=setInterval((function(){e.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:t.getState(),url:r}),"*")}),500),window.addEventListener("message",a)})()}}function i(o){let r=t.getCurrentSlide(),g=r.querySelectorAll("aside.notes"),u=r.querySelector(".current-fragment"),c={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:t.getState()};if(r.hasAttribute("data-notes")&&(c.notes=r.getAttribute("data-notes"),c.whitespace="pre-wrap"),u){let p=u.querySelector("aside.notes");p?(c.notes=p.innerHTML,c.markdown=typeof p.getAttribute("data-markdown")=="string",g=null):u.hasAttribute("data-notes")&&(c.notes=u.getAttribute("data-notes"),c.whitespace="pre-wrap",g=null)}g&&g.length&&(g=Array.from(g).filter((p=>p.closest(".fragment")===null)),c.notes=g.map((p=>p.innerHTML)).join(`
`),c.markdown=g[0]&&typeof g[0].getAttribute("data-markdown")=="string"),e.postMessage(JSON.stringify(c),"*")}function a(o){if((function(r){try{return window.location.origin===r.source.location.origin}catch{return!1}})(o))try{let r=JSON.parse(o.data);r&&r.namespace==="reveal-notes"&&r.type==="connected"?(clearInterval(d),s()):r&&r.namespace==="reveal-notes"&&r.type==="call"&&(function(g,u,c){let p=t[g].apply(t,u);e.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:p,callId:c}),"*")})(r.methodName,r.arguments,r.callId)}catch{}}function s(){t.on("slidechanged",i),t.on("fragmentshown",i),t.on("fragmenthidden",i),t.on("overviewhidden",i),t.on("overviewshown",i),t.on("paused",i),t.on("resumed",i),t.on("previewiframe",i),t.on("previewimage",i),t.on("previewvideo",i),t.on("closeoverlay",i),i()}return{id:"notes",init:function(o){t=o,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?n():window.addEventListener("message",(r=>{if(!e&&typeof r.data=="string"){let u;try{u=JSON.parse(r.data)}catch{}u&&u.namespace==="reveal-notes"&&u.type==="heartbeat"&&(g=r.source,e&&!e.closed?e.focus():(e=g,window.addEventListener("message",a),s()))}var g})),t.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},(function(){n()})))},open:n}};var An=()=>{let d,t,e,n,i,a,s;function o(){t=document.createElement("div"),t.classList.add("searchbox"),t.style.position="absolute",t.style.top="10px",t.style.right="10px",t.style.zIndex=10,t.innerHTML=`<input type="search" class="searchinput" placeholder="Search..." style="vertical-align: top;"/>
		</span>`,e=t.querySelector(".searchinput"),e.style.width="240px",e.style.fontSize="14px",e.style.padding="4px 6px",e.style.color="#000",e.style.background="#fff",e.style.borderRadius="2px",e.style.border="0",e.style.outline="0",e.style.boxShadow="0 2px 18px rgba(0, 0, 0, 0.2)",e.style["-webkit-appearance"]="none",d.getRevealElement().appendChild(t),e.addEventListener("keyup",(function(p){p.keyCode===13?(p.preventDefault(),(function(){if(a){var f=e.value;f===""?(s&&s.remove(),n=null):(s=new c("slidecontent"),n=s.apply(f),i=0)}n&&(n.length&&n.length<=i&&(i=0),n.length>i&&(d.slide(n[i].h,n[i].v),i++))})(),a=!1):a=!0}),!1),g()}function r(){t||o(),t.style.display="inline",e.focus(),e.select()}function g(){t||o(),t.style.display="none",s&&s.remove()}function u(){t||o(),t.style.display!=="inline"?r():g()}function c(p,f){var C=document.getElementById(p)||document.body,h=f||"EM",q=new RegExp("^(?:"+h+"|SCRIPT|FORM)$"),x=["#ff6","#a0ffff","#9f9","#f99","#f6f"],D=[],Y=0,M="",A=[];this.setRegex=function(S){S=S.trim(),M=new RegExp("("+S+")","i")},this.getRegex=function(){return M.toString().replace(/^\/\\b\(|\)\\b\/i$/g,"").replace(/\|/g," ")},this.hiliteWords=function(S){if(S!=null&&S&&M&&!q.test(S.nodeName)){if(S.hasChildNodes())for(var z=0;z<S.childNodes.length;z++)this.hiliteWords(S.childNodes[z]);var U,P;if(S.nodeType==3&&(U=S.nodeValue)&&(P=M.exec(U))){for(var v=S;v!=null&&v.nodeName!="SECTION";)v=v.parentNode;var T=d.getIndices(v),I=A.length,B=!1;for(z=0;z<I;z++)A[z].h===T.h&&A[z].v===T.v&&(B=!0);B||A.push(T),D[P[0].toLowerCase()]||(D[P[0].toLowerCase()]=x[Y++%x.length]);var F=document.createElement(h);F.appendChild(document.createTextNode(P[0])),F.style.backgroundColor=D[P[0].toLowerCase()],F.style.fontStyle="inherit",F.style.color="#000";var W=S.splitText(P.index);W.nodeValue=W.nodeValue.substring(P[0].length),S.parentNode.insertBefore(F,W)}}},this.remove=function(){for(var S,z=document.getElementsByTagName(h);z.length&&(S=z[0]);)S.parentNode.replaceChild(S.firstChild,S)},this.apply=function(S){if(S!=null&&S)return this.remove(),this.setRegex(S),this.hiliteWords(C),A}}return{id:"search",init:p=>{d=p,d.registerKeyboardShortcut("CTRL + Shift + F","Search"),document.addEventListener("keydown",(function(f){f.key=="F"&&(f.ctrlKey||f.metaKey)&&(f.preventDefault(),u())}),!1)},open:r,close:g,toggle:u}};window.Reveal=tt;tt.initialize({width:960,height:720,margin:0,controls:!0,controlsLayout:"bottom-right",controlsTutorial:!1,controlsBackArrows:"faded",progress:!1,slideNumber:"c/t",showSlideNumber:"all",hashOneBasedIndex:!0,hash:!0,respondToHashChanges:!1,jumpToSlide:!0,history:!1,keyboard:!0,keyboardCondition:null,disableLayout:!1,overview:!0,center:!1,touch:!0,loop:!1,rtl:!1,navigationMode:"linear",shuffle:!1,fragments:!0,fragmentInURL:!0,embedded:!1,help:!0,pause:!1,showNotes:!1,autoPlayMedia:null,preloadIframes:null,autoAnimate:!1,mouseWheel:!1,previewLinks:!1,transition:"none",transitionSpeed:"fast",backgroundTransition:"none",scrollLayout:"compact",scrollSnap:!1,pdfMaxPagesPerSlide:1,pdfSeparateFragments:!1,viewDistance:2,plugins:[En,An]});tt.addKeyBinding({keyCode:86,key:"V",description:"Toggle Scroll View"},()=>{let d=new URL(window.location.href);d.searchParams.get("view")==="scroll"?d.searchParams.delete("view"):d.searchParams.set("view","scroll"),window.location.replace(d)});export{tt as Reveal};
/*!
 * reveal.js 5.2.1
 * https://revealjs.com
 * MIT licensed
